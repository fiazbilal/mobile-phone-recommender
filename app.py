...
# st.set_page_config(page_title="Mobile Phone Data Extraction and Recommendation System using Machine Learning", page_icon=":📲:", layout="wide", initial_sidebar_state="expanded")
# st.set_theme('dark')
...
# st.markdown('> ##### ***Guide***: :Choose a mobile phone from the available options, and click the "Recommend" button. The system will instantly display the most similar mobile phones based on your selection. Using similarity metrics, the recommendation engine identifies and suggests devices that closely match your chosen phone, allowing you to discover alternatives that best fit your preferences and needs.. \n > ##### *Note*: :If If just click the recommend button again without selecting any mobiles you will get to see new mobile phones in the Other Variety of mobiles section.')
st.markdown('')
st.markdown(' ')
